...
{
	public class LSLStreamingHR : LSLStreamer
	{
		/// <summary>
		...
		public LSLStreamingHR(string PlayerID) : base(lslStreamName + "-" + PlayerID, lslStreamType, lslChannelCount, sampling_rate, lslChannelFormat, guid + "-" + PlayerID)
		{
